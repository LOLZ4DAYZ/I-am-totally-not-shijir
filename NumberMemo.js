  ...
  render(){
    ...
    <TouchableOpacity onPress = {this.generateRandomNumbers}>
      <View style ={{backgroundColor: "#ff567d"}}>
        <Text style = {{textAlign: "center", margin: 40, color: "white", fontSize: 40, fontWeight: "400"}}>Numbers</Text>
      </View>
      </TouchableOpacity>
      ...
      <View style = {{margin:20}}>
        ...
        <View style = {{backgroundColor: "#ff567d", height: 80, marginTop: 83, flexDirection: "row", justifyContent:"space-around"}}>
