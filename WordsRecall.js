...
class App extends Component{
  ...
  render(){
    ...
    <TouchableOpacity onPress = {this.generateRandomNumbers}>
      <View style ={{backgroundColor: "#ffaa7d"}}>
        <Text style = {{textAlign: "center", margin: 40, color: "white", fontSize: 40, fontWeight: "400"}}>Words Recall</Text>
      </View>
      </TouchableOpacity>
      ...
      <View style = {{margin:20}}>
        <TextInput keyboardType = "text" placeholder="Recall here"/>
      </View>
        <View style = {{backgroundColor: "#ffaa7d", height: 80, marginTop: 83, flexDirection: "row", justifyContent:"space-around"}}>
