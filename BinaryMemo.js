...
class App extends Component{
  ...
  render(){
    ...
    <TouchableOpacity onPress = {this.generateRandomNumbers}>
      <View style ={{backgroundColor: "#d263ff"}}>
        <Text style = {{textAlign: "center", margin: 40, color: "white", fontSize: 40, fontWeight: "400"}}>Binary</Text>
      </View>
      </TouchableOpacity>
      ...
      <View style = {{margin:20}}>
        ...
        <View style = {{backgroundColor: "#d263ff", height: 80, marginTop: 83, flexDirection: "row", justifyContent:"space-around"}}>
